...
class Book
{
    ...
    #[ORM\OneToMany(mappedBy: 'book', targetEntity: OrderItem::class, orphanRemoval: true)]
    ...
    {
        if ($description !== null) {
            $description = preg_replace('/^(<div>)+/', '', $description); //ken thama moshkla lahne fi description todhher "<div>" amma i managed to fix it 
